...
class SignUp extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const data = new FormData(event.target); // 폼데이터 가져와서
        const username = data.get("username"); // 내용 추출
        const email = data.get("email");
        const password = data.get("password");
        //signup(UserDTO) 매개변수에 오브젝트를 넘겨주고 call()요청 보냄
...
// 클래스 형태로 만든 컴포넌트 SignUp을 export함
